...
-- =====================================================
-- This script removes all problematic policies and functions
-- and restores the database to a working state
-- =====================================================
...
DROP POLICY IF EXISTS "pending_members_select_admin_or_self" ON pending_group_members;
DROP POLICY IF EXISTS "pending_members_insert_self" ON pending_group_members;
DROP POLICY IF EXISTS "pending_members_update_admin" ON pending_group_members;
DROP POLICY IF EXISTS "pending_members_delete_admin" ON pending_group_members;
...
DROP POLICY IF EXISTS "competitions_select_member" ON competitions;
DROP POLICY IF EXISTS "competitions_insert_member" ON competitions;
...
DROP POLICY IF EXISTS "competition_participants_select_member" ON competition_participants;
DROP POLICY IF EXISTS "competition_participants_insert_admin" ON competition_participants;
DROP POLICY IF EXISTS "competition_participants_delete_admin_or_self" ON competition_participants;
...
DROP POLICY IF EXISTS "matches_update_admin_or_player" ON matches;
...
DROP POLICY IF EXISTS "chat_messages_insert_system" ON chat_messages;
...
DROP POLICY IF EXISTS "player_stats_insert_authenticated" ON player_stats;
DROP POLICY IF EXISTS "player_stats_update_authenticated" ON player_stats;
DROP POLICY IF EXISTS "player_stats_delete_authenticated" ON player_stats;
...
-- =====================================================
-- These policies are based on the original schema
-- and avoid infinite recursion by using direct auth.uid() checks
-- =====================================================
