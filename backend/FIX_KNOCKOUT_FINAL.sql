-- ============================================
-- FINAL FIX FOR KNOCKOUT TOURNAMENTS
-- ============================================
-- This fixes:
-- 1. Stage and match_order populated at creation (already in TypeScript)
-- 2. Duplicate final and third place matches
-- 3. Display issues with stages
-- 4. Ensures only one final match exists
-- ============================================
...
SELECT '✅ Tournament progression trigger recreated' as status;

-- Check for any remaining duplicate finals
SELECT 
  competition_id,
...
-- Check for any remaining duplicate third place matches
SELECT 
  competition_id,
  COUNT(*) as third_place_count
FROM matches
WHERE stage = 'third_place'
GROUP BY competition_id
HAVING COUNT(*) > 1;
