-- Fix the unnest error in create_next_stage_matches function
-- The issue is with the WHERE clause referencing unnest incorrectly
...
BEGIN
  ...
  -- Fix: Remove NULL values from array correctly
