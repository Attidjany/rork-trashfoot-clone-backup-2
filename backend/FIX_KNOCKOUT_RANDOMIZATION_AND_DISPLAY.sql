-- Fix Knockout Tournament Issues:
-- 1. Add randomization to initial match creation
-- 2. Ensure matches display correctly in bracket view
-- 3. Verify stage progression triggers

-- ============================================
-- PART 1: Verify Required Columns Exist
-- ============================================

-- Check if stage and match_order columns exist
DO $$
BEGIN
  IF NOT EXISTS (
...
-- ============================================
-- PART 2: Ensure Realtime is Enabled
-- ============================================
...
-- ============================================
-- PART 3: Verify Tournament Progression Trigger
-- ============================================

-- Drop and recreate the tournament progression trigger
