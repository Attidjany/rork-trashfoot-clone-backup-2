...
BEGIN
  ...
  IF deleted_count > 0 THEN
    RAISE NOTICE '🗑️ Permanently deleted % old soft-deleted matches', deleted_count;
  END IF;
END;
$$;
...
BEGIN
  ...
  IF trigger_count = 3 AND function_count = 5 THEN
    RAISE NOTICE '✅ All triggers and functions installed successfully';
  ELSE
    RAISE WARNING '⚠️ Expected 3 triggers and 5 functions, found % triggers and % functions', trigger_count, function_count;
  END IF;
END $$;
